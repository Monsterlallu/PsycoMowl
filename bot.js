...
const {Message, StringSession, Image, Video} = require('./PsycoMowl/');
...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp... Please wait.')}`);
    ...
    conn.on('open', async () => {
        ...
        console.log(
            ...
            chalk.green.bold('PsycoMowl working! 👰')
...
*/
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '👰______```PsycoMowl-V2.1```_____👰' +
